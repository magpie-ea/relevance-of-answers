...
Since participants have not seen the answer when they rate the prior probability of a 'yes' answer, this is the only fixed effect we should include here.
...
### Answer polarity & answer certainty
