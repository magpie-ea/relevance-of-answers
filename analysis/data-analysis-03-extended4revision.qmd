...
if (rerun_models) {
  ...
  fit_loo_conccentration_change <- ordbetareg(
  ...
  write_rds(fit_loo_conccentration_change, "cachedModels-round2/fit_loo_conccentration_change.rds")
...
tibble(
  ...
  ELPD  = c(
    ...
    loo(fit_loo_conccentration_change)$estimates['elpd_loo','Estimate'],
  ...
  SE = c(
    ...
    loo(fit_loo_conccentration_change)$estimates['elpd_loo','SE'],
